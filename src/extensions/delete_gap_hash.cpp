#include "delete_gap_hash.hpp"

#include <btllib/nthash.hpp>
#include <stdexcept>
#include <string>

DeleteGapHash::DeleteGapHash(
...
std::vector<uint64_t*> DeleteGapHash::hashes() const
{
...
size_t DeleteGapHash::get_pos() const { return hashers[0].get_pos(); }